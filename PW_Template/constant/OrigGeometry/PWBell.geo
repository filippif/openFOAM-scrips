...
ri = DefineNumber[ 1.06, Name "Parameters/ri" ]; // entrance radius
...
//+
MeshSize {1, out[1], out[2], out[3], 4, 3, 2} = rt/3;
MeshSize {90, 91, 92, 93, 94, 95} = rt/3;
MeshSize {96, 97, 98, 99, 100, 101} = rt;
MeshSize {102, 103, 104, 105, 106, 107} = rt;
