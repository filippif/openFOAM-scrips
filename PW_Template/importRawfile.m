function [x,y,z,p] = importRawfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   [X,Y,Z,P] = IMPORTFILE(FILENAME) Reads data from text file FILENAME for
%   the default selection.
%
%   [X,Y,Z,P] = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   [x,y,z,p] = importfile('p_surf1.raw',3, 4390);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2018/09/12 15:50:08
